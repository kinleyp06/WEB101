        ...
        <div className="border rounded-lg p-6">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-4 text-right">
              <Link href="/reset-password" className="text-sm text-gray-500 hover:underline">Forgot password?</Link>
            </div>
            ...
            <div className="mt-4 text-center">
              ...
              <Link href="/signup" className="text-red-500 font-medium hover:underline">Sign up</Link>
            </div>
          </form>
        </div>
      </div>
